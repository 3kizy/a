...
function Library:create(options)
	...
	creditsTab:credit{Name = "Russian", Description = "UI Library Developer", Discord = "xuhinii#7269"}
	creditsTab:credit{Name = "Teox", Description = "UI Library Developer", Discord = "LT.#9171"}
